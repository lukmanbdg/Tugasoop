 ...
 */
public class teknikIndustri extends perwalianMahasiswa {
    
    String namamhsti, namamhsti2, alamatmhsti, pendidikanterakhir, jeniskelamin, notelpon;
    int umurmhsti, pilih, noreg, nopil;
    
    void pendaftaranTeknikIndustri(){
        ...
        while (pilih==0)
		{
            ...
            switch (pilih) {
                case 1:
                    ...
                    System.out.println("=======================================================");
                    System.out.println("Nomor Induk Mahasiswa Anda adalah : 17 829 4252");
                    System.out.println();
                    System.out.println();
